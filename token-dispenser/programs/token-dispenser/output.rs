...
mod __private {
    ...
    pub mod __global {
        ...
        pub fn initialize(
            ...
            let instruction::Initialize { target_config } = ix;
        ...
        for claim_certificate in &claim_certificates {
            ...
            merkle_root
                .check(
                    MerklePath::<
                        Keccak256,
                    >::new(claim_certificate.proof_of_inclusion.clone()),
                    &leaf_vector,
                );
...
pub mod instruction {
        ...
        Config: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.target_config, writer)?;
            Ok(())
        }
    }
        ...
        Config: borsh::BorshDeserialize,
    {
        fn deserialize(
            ...
            Ok(Self {
                target_config: borsh::BorshDeserialize::deserialize(buf)?,
            })
        }
    }
...
pub struct Initialize<'info> {
    ...
    #[account(init, payer = payer, space = 0, seeds = [CONFIG_SEED], bump)]
    ...
    'info: 'info,
{
    ...
    fn try_accounts(
        ...
        let __Args { target_config } = __Args::deserialize(&mut ix_data)
    ...
    Pubkey: borsh::BorshDeserialize,
{
    fn deserialize(
        ...
        let return_value = match variant_idx {
            0u8 => Identity::Discord,
            1u8 => Identity::Solana(borsh::BorshDeserialize::deserialize(buf)?),
            2u8 => Identity::Evm,
            3u8 => Identity::Sui,
            4u8 => Identity::Aptos,
            5u8 => Identity::Cosmwasm,
            _ => {
                let msg = {
...
impl ::core::clone::Clone for Identity {
    ...
    fn clone(&self) -> Identity {
        match self {
            ...
            Identity::Solana(__self_0) => {
                Identity::Solana(::core::clone::Clone::clone(__self_0))
            }
            Identity::Evm => Identity::Evm,
            Identity::Sui => Identity::Sui,
            Identity::Aptos => Identity::Aptos,
            Identity::Cosmwasm => Identity::Cosmwasm,
        }
    }
}
pub struct ClaimCertificate {
    ...
    amount: u64,
    proof_of_inclusion: Vec<[u8; 32]>,
}
impl borsh::de::BorshDeserialize for ClaimCertificate
where
    ProofOfIdentity: borsh::BorshDeserialize,
    u64: borsh::BorshDeserialize,
...
where
    ProofOfIdentity: borsh::ser::BorshSerialize,
    u64: borsh::ser::BorshSerialize,
...
impl borsh::de::BorshDeserialize for ProofOfIdentity
where
    Vec<u8>: borsh::BorshDeserialize,
{
    fn deserialize(
        ...
        let variant_idx: u8 = borsh::BorshDeserialize::deserialize(buf)?;
        let return_value = match variant_idx {
            0u8 => ProofOfIdentity::Discord,
            1u8 => ProofOfIdentity::Solana(borsh::BorshDeserialize::deserialize(buf)?),
            2u8 => ProofOfIdentity::Evm,
            3u8 => ProofOfIdentity::Sui,
            4u8 => ProofOfIdentity::Aptos,
            5u8 => ProofOfIdentity::Cosmwasm,
            _ => {
                let msg = {
                    let res = ::alloc::fmt::format(
                        ::core::fmt::Arguments::new_v1(
...
impl borsh::ser::BorshSerialize for ProofOfIdentity
where
    Vec<u8>: borsh::ser::BorshSerialize,
{
    fn serialize<W: borsh::maybestd::io::Write>(
        ...
        let variant_idx: u8 = match self {
            ProofOfIdentity::Discord => 0u8,
            ProofOfIdentity::Solana(..) => 1u8,
            ProofOfIdentity::Evm => 2u8,
            ProofOfIdentity::Sui => 3u8,
            ProofOfIdentity::Aptos => 4u8,
            ProofOfIdentity::Cosmwasm => 5u8,
        };
        writer.write_all(&variant_idx.to_le_bytes())?;
        match self {
            ProofOfIdentity::Discord => {}
            ProofOfIdentity::Solana(id0) => {
                borsh::BorshSerialize::serialize(id0, writer)?;
            }
            ProofOfIdentity::Evm => {}
            ProofOfIdentity::Sui => {}
            ProofOfIdentity::Aptos => {}
...
#[automatically_derived]
impl ::core::clone::Clone for ProofOfIdentity {
    #[inline]
    fn clone(&self) -> ProofOfIdentity {
        match self {
            ProofOfIdentity::Discord => ProofOfIdentity::Discord,
            ProofOfIdentity::Solana(__self_0) => {
                ProofOfIdentity::Solana(::core::clone::Clone::clone(__self_0))
            }
            ProofOfIdentity::Evm => ProofOfIdentity::Evm,
            ProofOfIdentity::Sui => ProofOfIdentity::Sui,
            ProofOfIdentity::Aptos => ProofOfIdentity::Aptos,
            ProofOfIdentity::Cosmwasm => ProofOfIdentity::Cosmwasm,
        }
    }
}
...
pub fn verify_one_identity_per_ecosystem(
    claim_certificates: &Vec<ClaimCertificate>,
) -> Result<()> {
